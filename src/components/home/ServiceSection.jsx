    ...
    return (
        <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-8 items-center">
                ...
                <p className="text-center text-gray-700 lg:max-w-xl">I have been in the industry for 8+ years and gained rich experience in web and mobile development. In business, we are not doing a college project, but face actual customers and I can help you launch your product with my expertise and experience</p>
            </div>
