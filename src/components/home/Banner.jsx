...
export default function Banner() {
    return (
        <div className="px-6 pt-6 rounded-xl bg-white grid grid-cols-5 duration-500 dark:bg-dark-bg-primary">
            <div className="col-span-5 lg:col-span-3 p-6 flex flex-col justify-center gap-4">
                <h1 className="text-4xl font-extrabold dark:text-white">I'm Philip Acho<br/><span className="text-primary">Full-stack</span> Developer</h1>
